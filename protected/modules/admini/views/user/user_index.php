...
<div id="contentHeader">
  ...
  <!--<div class="searchArea">
    <ul class="action left" >
      <li><a href="<?php /*echo $this->createUrl('create')*/?>" class="actionBtn"><span>新建</span></a></li>
    </ul>
