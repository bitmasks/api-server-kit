...
<div id="contentHeader">
  ...
  <div class="searchArea">
    <ul class="action left" >
      <li><a href="<?php echo $this->createUrl('specialCreate')?>" class="actionBtn"><span>新建</span></a></li>
    </ul>
  ...
  <form method="post" action="<?php echo $this->createUrl('batch')?>" name="cpform" >
    ...
    <tr class="tb_list">
      ...
      <td ><?php echo $row->title?><br />
       <a href="<?php echo $this->createAbsoluteUrl('/special/show',array('name'=>$row->title_alias))?>" target="_blank"><?php echo $row->title_alias?></a></td>
