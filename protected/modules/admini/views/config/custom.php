...
<form action="" method="post"  enctype="multipart/form-data" >
  ...
  <div class="submit" style="padding-top:10px">
    ...
    <a href="<?php echo $this->createUrl('attr/create')?>" class="actionLink"><span>新建更多属性</span></a> </div>
</form>
<?php else:?>
<a href="<?php echo $this->createUrl('attr/create')?>" class="actionLink"><span>请先新建属性</span></a>
