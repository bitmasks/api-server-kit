  ...
  <div class="mainWrap">
    ...
    <div class="global goods">
      <div class="loc clear">
        ...
        <div class="floatR position"> <span>您的位置：</span> <a href="<?php echo Yii::app()->homeUrl?>">首页</a> <em></em><span><?php echo $catalogArr['catalog_name']?></span></div>
      </div>
      <div class="catalog"><?php if($catalogArr):?><a href="<?php echo $this->createUrl('index',array('catalog'=>$catalogArr['catalog_name_alias'])) ?>"><?php echo $catalogArr['catalog_name']?></a><?php else:?><span>列表</span><?php endif?> <?php foreach((array)$catalogChild as $row):?>
